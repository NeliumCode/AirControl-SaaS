...
export DOCKER_INFLUXDB_DATA_PATH=$DOCKER_INFLUXDB_DATA_PATH
export DOCKER_INFLUXDB_CFÇ=$DOCKER_INFLUXDB_CFG_PATH
...
influx setup --skip-verify --bucket ${DOCKER_INFLUXDB_INIT_BUCKET} --token ${DOCKER_INFLUXDB_INIT_ADMIN_TOKEN} --org ${DOCKER_INFLUXDB_INIT_ORG} --username ${DOCKER_INFLUXDB_INIT_USERNAME} --password ${DOCKER_INFLUXDB_INIT_PASSWORD} --force